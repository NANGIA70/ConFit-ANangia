# all_labels_csv=../resume_v3/dataset/IntelliPro_0417_2025/intermediate/all_labels_pos.csv
# rank_resume_file=../resume_v3/dataset/IntelliPro_0417_2025/processed_seed17/rank_resume.json
# jd_file=../resume_v3/dataset/IntelliPro_0417_2025/processed/all_jd_texts.csv
all_labels_csv=dataset/all_labels_pos.csv
rank_resume_file=dataset/rank_resume.json
jd_file=dataset/all_jd_texts.csv

output_dir=/local/data/xy2437/articulate_ai/resume/dataset/tmp/results
cache_dir=/local/data/xy2437/articulate_ai/resume/dataset/tmp/cache
